...
def roll_initiative(hero, enemy):
    ...
    print(f"{hero.get_name()} rolls a {hero_initiative}, {enemy.get_name()} rolls a {enemy_initiative}")
...
def attack(name, roll, accuracy, damage, dmg_type, # attacker stats
    ...
    print(f"{name}'s attack roll: {roll+accuracy}")
    if roll+accuracy > ac:
...
def enemy_attack(hero, enemy):
    ...
    if damage:
        ...
        print(f"{hero.get_name()} took {damage} {enemy.get_dmg_type()} damage.")
...
def hero_attack(hero, enemy, attack_weapon):
    ...
    if damage:
        ...
        print(f"{enemy.get_name()} took {damage} {attack_weapon.get_dmg_type()} damage.")
...
def fight(hero, enemy):
    ...
    if not hero.get_hp():
        ...
        print(f"{hero.get_name()} has killed {enemy.get_name()}!")
    hero.update()
